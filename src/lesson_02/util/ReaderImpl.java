...
public class ReaderImpl implements Reader {
    ...
    public void printInstruction() {
        ...
        if (role.equals("ADMIN")) {
            ...
            // 1 -  спросить какого кота редактировать
            // 2 - найти кота по методу findCat
            // 3 - спросить у пользователя ввести новые данные котов по порядку
            // 4 - взять текущий массив котов и в нем удалить кота по id из п. 1 и добавить нового кота из п.3
            System.out.println(" 4 - Редактировать кота");
            // 1 -  спросить какого кота редактировать
            // 2 - найти кота по методу findCat
            // 3 - взять текущий массив котов и в нем удалить кота по id из п. 1
